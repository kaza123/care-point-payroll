(function () {
    //module
    angular.module("shortLeaveModule", ['ui.bootstrap', 'ui-notification']);

    //http factory
    angular.module("shortLeaveModule")
            .factory("shortLeaveFactory", function ($http, systemConfig) {
                var factory = {};
    ...
    //controller
    angular.module("shortLeaveModule")
            .controller("shortLeaveController", function ($scope, $filter, shortLeaveFactory, Notification, $timeout) {
                //data models 
                $scope.model = {};
                $scope.model.leave = {
                    employee: null,
...
//                };
                ...
                $scope.http.saveLeaveRequest = function () {
                    ...
                    shortLeaveFactory.saveLeaveRequestFactory(
                            detailJSON,
                            function (data) {
                ...
                $scope.http.selectEpfNo = function (keyEvent, epfNo) {
                    if (keyEvent.which === 13)
                        shortLeaveFactory.findEmployeeByEpfNo(epfNo
                                , function (data) {
