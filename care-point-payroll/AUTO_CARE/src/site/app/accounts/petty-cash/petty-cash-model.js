...
(function () {
    var factory = function (pettyCashFactory, pettyCashService, $q, $filter, Notification) {
        ...
        employeeModel.prototype = {
            ...
            constructor: function () {
                var that = this;
                that.data = pettyCashFactory.Data();
...
//                        });
                pettyCashService.loadAccAccounts()
                        .success(function (data) {
                            that.accAccountList = data;
                            console.log(data);
                        });
                pettyCashService.loadBranch()
                        .success(function (data) {
                            that.branchList = data;
                        });
                pettyCashService.currentBranch()
                        .success(function (data) {
            ...
            new : function () {
                ...
                this.data.currentBranch = this.currentBranch.indexNo;
                this.getCashValue(this.data.currentBranch);

            }
            ,
            getCashValue:function (branch){
            ...
            getAccountValueFrom:function (branch,accAccount){
                var that = this;
                pettyCashService.getAccountValue(branch,accAccount)
                        .success(function (data) {
...
//            }
    ...
    angular.module("appModule")
            .factory("pettyCashModel", factory);
}());
