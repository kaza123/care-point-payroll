...
//        };
        ...
        this.getAccountValue = function (branch,accAccount) {
            return $http.get(systemConfig.apiUrl + "/api/care-point/account/master/acc-account/get-account-value/"+branch+"/"+accAccount);
        };
...
//        };
//        this.numberList = function (number) {
//            return $http.get(systemConfig.apiUrl + "/api/care-point/transaction/journal/find-number/"+number);
//        };
...
//        };
    ...
    angular.module("appModule")
            .service("pettyCashService", service);
}());