 ...
 */
package com.mac.care_point.transaction.finger_print;
...
import com.mac.care_point.transaction.common.Constant;
import com.mac.care_point.transaction.employee_assignment.EmployeeAssignmentRepository;
import com.mac.care_point.transaction.employee_assignment.model.TEmployeeAssingment;
import com.mac.care_point.transaction.finger_print.model.TFingerPrint;
import com.mac.care_point.transaction.finger_print.model.TFingerPrintMashine;
...
public class FingerPrintService {
    ...
    public Integer save(TFingerPrint fingerPrint) {
        fingerPrint.setIsIn(Boolean.FALSE);
        fingerPrint.setIsOut(Boolean.FALSE);
        fingerPrint.setType("MANUAL");
    ...
    public Integer saveOutTime(TFingerPrint fingerPrint) {
        fingerPrintRepository.save(fingerPrint);
        return 1;
    }
