...
public class FingerPrintController {
    ...
    @RequestMapping(value = "/manual-save-outtime", method = RequestMethod.POST)
    public Integer insertOutTime(@RequestBody TFingerPrint fingerPrint) {                
        return fingerPrintService.saveOutTime(fingerPrint);
    }
